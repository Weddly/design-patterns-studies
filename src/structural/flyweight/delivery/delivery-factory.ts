import { DeliveryFlyweigth } from "./delivery-flyweight";
import { DeliveryLocation } from "./delivery-location";
import { DeliveryLocationData, DeliveryLocationDictionary } from "./delivery-type";
...
export class DeliveryFactory {
    ...
    createLocation(intrinsicState: DeliveryLocationData): DeliveryFlyweigth {
