...
var InputObservable = /** @class */ (function () {
    ...
    InputObservable.prototype.notify = function () {
        var _this = this;
        this.observers.forEach(function (o) { return o.update(_this); });
    };
...
function makeParagraph() {
    ...
    p.innerText = 'Hardcoded <p>';
    return p;
}
function makeDiv() {
    var div = document.createElement('div');
    document.body.appendChild(div);
    div.innerText = 'Hardcoded <div>';
...
// Notes:
// Running html using Live Server
// Compiling .ts to .js with hot reload using:
